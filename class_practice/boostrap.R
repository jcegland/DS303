...
## Based on this data set, provide an estimate for the population mean of medv. Call this muhat.
## Estimate the standard error of muhat using the bootstrap.
## Compare this to the standard error of muhat using the analytical formula (the one you've seen in intro stats). How do they compare? 
mean(Boston$medv) 
n = dim(Boston)[1]
set.seed(1)
B = 2000
...
# very similar values for both standard errors. the standard error for bootstrap is slightly smaller 
