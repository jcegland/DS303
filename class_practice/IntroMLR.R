...
patient = read.table("/Users/jillianeglandschool/Desktop/DS303/patient.txt",header=FALSE)
...
#shortcut: to call all columns . 
# .-age calls all columns except for age 
...
## How can we check this using simulated data?  

########################
## In-class Activity  ##
########################

## Design a simulation to check whether or not our least square estimates for beta_0 and beta_1 are unbiased. 
## Work in groups to come up with a solution. 
## Copy and paste your code on Ed Discussion. 
## Please be sure to list all your group members names. Only one group memeber needs to post on Ed Discussion. 
