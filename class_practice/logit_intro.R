...
## number of yeses that were incorrectly classified as no divided by total 
## .031
...
## more expensive to say no they won't default when they actually will 
...
## since our yeses are more expensive, we have a rate of .658 error for our yesses 
## glm.pred[glm.prob >0.25] ='Yes' now .43 error rate 
## overall rate now .035 
