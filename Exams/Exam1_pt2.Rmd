...
## 4
The error was generated using mean 0 and standard deviation of 1, so the irriducible error for this model is approximately 0. 


## 5
Expected Test MSE for each model: 
```{r}
(bias1) + var1 + 0
(bias2) + var2 + 0
(bias3) + var3 + 0
