...
null distribution: assuming the errors are normal, we can assume that the t's are also normal when H0 is true. This is the distribution of the test statistic for age, assuming that the coefficient for age is 0.  
p-value: 6.59e-13  
...
null distribution: the distribution of the f test statistics assuming the errors are normal, we assume H0 is true.  
p-value: < 2.2e-16  
